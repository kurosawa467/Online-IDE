...
public class ProjectApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Project project = projectService.createProject(new Project("my-project12"));
		log.info("ID of saved project = " + project.getId());
		Project p = projectService.findByName("my-project12");
		...
		SourceFile sourceFile1 = sourceFileService.createSourceFile(new SourceFile(project, "sourcefile5", "java"));
		log.info("ID of saved source code = " + sourceFile1.getId());
		SourceFile sourceFile2 = sourceFileService.createSourceFile(new SourceFile(project, "sourcefile6", "main"));
