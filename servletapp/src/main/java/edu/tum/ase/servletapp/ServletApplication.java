...
public class ServletApplication {
    ...
    public static void main_1(String[] args) throws LifecycleException {
        EmbeddedTomcatServer webServer = new EmbeddedTomcatServer();
        webServer.registerServletHandler(new HelloWorldServlet());
        webServer.run();
    }
}
